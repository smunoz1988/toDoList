...
**Awesome** is a html, css and js project. Its only for educational purpose and it use webpack.
...
- Webpack
- To do list items created dinamycally in JS.
...
git@github.com:smunoz1988/toDoList.git
